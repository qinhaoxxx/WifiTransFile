...
STRINGS.CANCEL = '取消';
STRINGS.SELECT_YOUR_FILES = '请选择您要上传到提分宝典客户端的文件';
STRINGS.SUPPORTED_FILE_TYPES = '支持TFBD文件';
STRINGS.CANNOT_CONNECT_SERVER = '无法连接WiFi传输服务器，请重新打开WiFi传输服务并刷新此页后重新上传。';
STRINGS.DRAG_TO_HERE = "拖拽到此处上传";
STRINGS.SELECT_BUTTON_LABLE1 = "选择文件夹";
